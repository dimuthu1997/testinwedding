...
$stmt = $con->prepare('SELECT password, email FROM supplier WHERE supplierId = ?');
	...
	<body>
      <header class="head1">
       ...
       <nav class="navbar navbar-expand-md navbar-light">
              ...
              <img id="brand-image" alt="website Logo" src="img/logo.png"> </a>
              <ul class="nav-item ml-auto">
              <a href="profile1.php"  class="btn btn-dark btn-lg active" role="button" aria-pressed="true"><i class="fas fa-user-circle" style='font-size:24px'></i>Profile</a>                              
              <a href="logout1.php" class="btn btn-dark btn-lg active"  role="button" aria-pressed="true"><i class="fas fa-sign-out-alt" style='font-size:24px'></i>Logout</a>
              </ul>
