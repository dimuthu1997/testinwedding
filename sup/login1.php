      ...
      <div class="row">
             ...
             <div class="col-lg-8 col-md-12 col-sm-9 col-xs-12 form-box text-center">
                    ...
                    <div class="form-input">
                           ...
                           <input type="text" placeholder="User Name" name="suppliername" required>
                           </div>
                           <div class="form-input">
                     ...
                     <div class="text-left mb-3">
                           ...
                           <div style="color: #000">Don't have an account<a href="supjoin.php" class="signup-link"> Sign up here</a>
